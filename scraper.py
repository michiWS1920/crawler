...
url = "https://www.cbssports.com/fantasy/football/stats/WR/{}/stats/nonppr/"
...
for year_url in years:
    ...
    for item in body:
        ...
        fumble = allstats[11].text.strip()
        fpoints = allstats[12].text.strip()
        fpergame = allstats[13].text.strip()
